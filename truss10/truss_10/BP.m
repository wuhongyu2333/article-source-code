profile on 
load data.txt   -ASCII
train_feature=data(1:8000,1:10)';
train_label=abs(data(1:8000,12))';
test_feature=data(8001:10000,1:10)';
test_label=abs(data(8001:10000,12))'; 
% 
...
%% 开始构建BP网络
net=newff(train_feature_deal,train_label_deal,{hiddennum1,hiddennum2,hiddennum3,hiddennum4});              
%设定参数网络参数
